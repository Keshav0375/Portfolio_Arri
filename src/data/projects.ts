...
export const projects = [
  {
    ...
    tags: ["Python", "DALL·E 3", "ElevenLabs API", "React", "OpenCV", "Flask"],
  ...
  },
  {
    ...
    tags: ["Python", "NLP", "LangChain", "React", "OpenAI API", "Claude"],
  ...
  },
  {
    ...
    tags: ["Python", "LangChain", "LangSmith", "ChromaDB", "FastAPI", "SQL"],
  ...
  },
  {
    ...
    tags: ["Python", "FastAPI", "OpenAI API", "Docker", "STORM", "Streaming Response"],
  ...
  },
  {
    id: 6,
    title: "AgenticIQ",
    description: "AI-Powered Academic Assistant with LangChain Orchestration",
    image: "https://images.pexels.com/photos/6770610/pexels-photo-6770610.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    tags: ["Python", "LangChain", "Streamlit", "LangFlow", "REST API", "Prompt Engineering"],
    codeLink: "https://github.com/Keshav0375/AgenticIQ",
    details: "Developed a personalized AI academic assistant that simulates domain expertise in Applied Computing and AI, leveraging LangFlow for orchestration and LangChain for robust agent workflows. Implemented a responsive Streamlit interface with custom styling that enhances user experience through intuitive chat interactions. Engineered a robust backend system that connects to remote LangFlow endpoints via REST API with secure token-based authentication, ensuring reliable performance while maintaining contextual awareness across complex academic conversations."
  }
];